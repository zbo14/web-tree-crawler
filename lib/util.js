 ...
 * @return {Object}
 */
const getOpts = ({ numRequests, startPaths, timeLimit, verbose }) => {
  numRequests = isPositiveInteger(numRequests) ? numRequests : 200
  ...
  return { numRequests, startPaths, timeLimit, verbose }
}
